            ...
            <div className={styles.tip}>
                {slug
                    ...
                    : <span style={{ color: 'orange' }}>
                          YOU FOUND A MISSING FEATURE! There is no data because
                          you Refreshed the video page, whose data is fetched on
                          the previous page. Try adding a thunk to this route in
                        <span style={{ color: 'white' }}>
                            {' '}configureStore.js{' '}
                        </span>
                          to insure when visited directly this page has its data
                          as well. Use the
                        <span style={{ color: 'white' }}>
                            {' '}findVideo(slug){' '}
                        </span>
